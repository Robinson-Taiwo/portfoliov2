...
const Projects = () => {
    return (
        <div className="w-full mt-32 max-w-[1000px] flex-col flex items-center relative  justify-center " >

            {/* projects header */}

            <div className='flex lg:flex-row   px-[1.4rem] md:px-10 lg:px-0 relative flex-col  w-full ' >
            ...
            <div className="w-full flex md:px-12 lg:px-0 flex-col  h-full gap-24 relative  " >
                <ProjectComponent />
                <ProjectComponent />
                <ProjectComponent />
                <ProjectComponent />
